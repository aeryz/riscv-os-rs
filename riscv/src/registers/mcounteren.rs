...
#[repr(transparent)]
pub struct Mcounteren(usize);

impl Mcounteren {
    pub const IR_SHIFT: usize = 2;
    pub const IR_MASK: usize = 1 << Self::IR_SHIFT;

    pub const TM_SHIFT: usize = 1;
    pub const TM_MASK: usize = 1 << Self::TM_SHIFT;

    pub const CY_SHIFT: usize = 0;
    pub const CY_MASK: usize = 1 << Self::CY_SHIFT;
